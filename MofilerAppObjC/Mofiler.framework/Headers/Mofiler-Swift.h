...
- (void)injectValueWithNewValue:(NSDictionary<NSString *, NSString *> * _Nonnull)newValue;
- (void)injectValueWithNewValue:(NSDictionary<NSString *, NSString *> * _Nonnull)newValue dateOfExpiry:(float)dateOfExpiry;
