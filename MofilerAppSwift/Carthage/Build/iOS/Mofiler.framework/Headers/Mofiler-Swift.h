...
- (void)initializeWithAppKey:(NSString * _Nonnull)appKey appName:(NSString * _Nonnull)appName identity:(NSDictionary<NSString *, NSString *> * _Nonnull)identity useAdvertisingId:(BOOL)useAdvertisingId SWIFT_METHOD_FAMILY(none);
